...
@app.route('/')
def home():
    return "⚡ SIAM CODEX HOSTING CORE IS OPERATIONAL 24/7 🚀"
...
POWERED_BY_TEXT = "ᴘᴏᴡᴇʀᴇᴅ ʙʏ @ꜱɪᴀᴍ_ᴄᴏᴅᴇx"
...
def start_handler(message):
    ...
    role_badge = "👑 ᴀᴅᴍɪɴ" if user_id in admin_ids else ("💎 ᴘʀᴇᴍɪᴜᴍ" if is_premium else "🆓 ꜰʀᴇᴇ")
    
    welcome_text = f"""
🚀 <b>{to_small_caps('SIAM CODEX CLOUD HOSTING CORE')}</b> ☠️
━━━━━━━━━━━━━━━━━━━━━━━
...
def help_menu_handler(message):
    text = f"""
🆘 <b>{to_small_caps('SIAM CODEX USER MANUAL')}</b>
━━━━━━━━━━━━━━━━━━━━━━━
...
if __name__ == "__main__":
    ...
    logger.info("⚡ STARTING SIAM CODEX POLLING LOOP...")
    while True:
        try:
